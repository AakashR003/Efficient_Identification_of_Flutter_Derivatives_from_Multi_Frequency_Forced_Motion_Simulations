...
for i in frequency:
    ...
    path_output = os.path.join(str(iteration_variable2) + path_base,"Amplitude_and_Phase")
    ...
    write_amplitude_phase_file(path_output,f"{iteration_variable2}_Pitch_Amplitude_Phase.txt",pitch_dict,pitch_columns)

    # ---------- Heave ----------
    heave_columns = ["Heave Amplitude","Fy Amplitude","Phase Fy","Moment Amplitude","Phase Mx"]
    write_amplitude_phase_file(path_output,f"{iteration_variable2}_Heave_Amplitude_Phase.txt",heave_dict,heave_columns)
