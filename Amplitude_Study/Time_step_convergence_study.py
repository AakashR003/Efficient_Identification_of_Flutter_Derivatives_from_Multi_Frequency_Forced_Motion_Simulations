...
def plot_amplitude_vs_frequency(components, path_DFT):
    ...
    parts = os.path.normpath(path_DFT_Fy).split(os.sep)
    plt.title(f"Ampltide Spectrum {parts[-3]} {os.path.basename(path_DFT_Fy).replace('DFT_','').replace('.png','')} {parts[-4]}")
            ...
            for frequency_tuple in frequency_list:
                ...
                for time_interval in time_interval_list:
                    ...
                    if prescribed_motion == "Heave":
                        ...
                        Derivatives = [
                            (H2_list, "H2*", "H2* Convergence Study", "H2_TimeStep_Convergence.png"),
                            (H3_list, "H3*", "H3* Convergence Study", "H3_TimeStep_Convergence.png"),
                            (A2_list, "A2*", "A2* Convergence Study", "A2_TimeStep_Convergence.png"),
                            (A3_list, "A3*", "A3* Convergence Study", "A3_TimeStep_Convergence.png"),
                        ]
